...
* Method named **getWidth without any parameters**, it needs to **return** the 
...
Write a class with the name **Cuboid** that extends **Rectangle** class. The 
class 
...
and height** all of type **double**. It needs to **call parent constructor** 
and 
